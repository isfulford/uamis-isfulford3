...
namespace uamis_isfulford3.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MovieId,Title,IMDBLink,Genre,ReleaseDate")] Movie movie, IFormFile Photo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MovieId,Title,IMDBLink,Genre,ReleaseDate,Photo")] Movie movie)
        {
            if (id != movie.MovieId)
            {
                return NotFound();
